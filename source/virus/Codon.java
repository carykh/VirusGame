...
public class Codon extends CodonPair { //this includes health
 ...
 public double codonHealth = 1;
  ...
  public int getColor(int p) {
    ...
    //returnintToColor(CodonInfo.getColor(p, codonInfo[p]));
  }
  ...
  public static int memoryIdColor(int id) {
    id += 45; //make sure its positive
    //90 possible ids, 90 colours
    float angle = 45 + 22.5f /*major angle*/ + 4 /*minor angle*/;
    float hue = angle * id % 360 / 360;

    return java.awt.Color.HSBtoRGB(hue, 0.7f, 0.7f);
  }

  public static CodonPair fromIntList(int[] ints) {
  ...
  public enum CodonAttributes {
    ...
    CodonAttributes(CodonAttribute value) {
      this.v = value;
    }
  }


  public static class CommonBase implements Cloneable {
    int id;
    int[] backColor;
    int[] textColor;
    String name;
  ...
  public static class CodonType extends CommonBase {
  ...
  public static class CodonAttribute extends CommonBase {
  ...
  public static class AttributeNone extends CodonAttribute {
    public AttributeNone() {
      super(0, c(0, 0, 0), c(255, 255, 255), "none");
    }
  }

  public static class AttributeParticle extends CodonAttribute {
  ...
  public static class AttributeFood extends AttributeParticle {
    public AttributeFood() {
      super(1, c(200, 50, 50), c(255, 255, 255), ParticleType.Food);
    }
  }

  public static class AttributeWaste extends AttributeParticle {
    public AttributeWaste() {
      super(2, c(100, 65, 0), c(255, 255, 255), ParticleType.Waste);
    }
  }

  public static class AttributeUGO extends AttributeParticle {
    public AttributeUGO() {
      super(8, c(158, 28, 128), c(255, 255, 255), ParticleType.UGO);
    }
  }

  public static class AttributeWall extends CodonAttribute {
    public AttributeWall() {
      super(3, c(160, 80, 160), c(255, 255, 255), "wall");
    }
  }

  public static class AttributeGenomeCursor extends CodonAttribute {
  ...
  public static class AttributeGenomeCursorDirection extends AttributeGenomeCursor {
    boolean inwards;
  ...
  public static class AttributeGenomeLoc extends AttributeGenomeCursor {
    int loc;
    boolean isRelative;
  ...
  public static class AttributeGenomeRange extends AttributeGenomeLoc {
    int end;
  ...
  public static class AttributeWeakLoc extends AttributeGenomeLoc {
  ...
  public static class AttributeInward extends AttributeGenomeCursorDirection {
    public AttributeInward() {
      super(5, c(0, 100, 100), c(255, 255, 255), "inward", true);
    }
  }

  public static class AttributeOutward extends AttributeGenomeCursorDirection {
    public AttributeOutward() {
      super(6, c(0, 200, 200), c(255, 255, 255), "outward", false);
    }
  }

  public static class AttributeRGL extends AttributeGenomeRange {
    ...
    public CodonAttribute createRandom() {
      return new AttributeRGL(randomInt(enMin, enMax), randomInt(enMin, enMax));
    }


  }

  public static class AbsoluteRange {
    int start;
    int length;
  ...
  public static class AttributeMemoryLocation extends AttributeGenomeRange {
    int memoryId;
    ...
    public CodonAttribute createRandom() {
      return new AttributeMemoryLocation(randomInt(enMin, enMax));
    }
  ...
  public static class AttributeMark extends CodonAttribute {
    int markId;
    ...
    public CodonAttribute createRandom() {
      return new AttributeMark(randomInt(enMin, enMax));
    }

  }


  public static class AttributeCursor extends AttributeGenomeLoc {
  ...
  public static class AttributeDegree extends AttributeGenomeLoc {
    int degMajor;
    int degMinor;
    ...
    public CodonAttribute createRandom() {
      return new AttributeDegree(randomInt(0, 360));
    }
  ...
  public static class Attribute extends CodonAttribute {
    public Attribute() {
  ...
  //Define all Types
  public static class CodonNone extends CodonType {
    public CodonNone() {
      super(0, c(0, 0, 0), c(255, 255, 255), "none");
    }
  ...
  public static class CodonDigest extends CodonType {
    public CodonDigest() {
  ...
  public static class CodonRemove extends CodonType {
    public CodonRemove() {
  ...
  public static class CodonRepair extends CodonType {
    public CodonRepair() {
  ...
  public static class CodonMoveHand extends CodonType {
    boolean direction;
  ...
  public static class CodonRead extends CodonType {
    public CodonRead() {
  ...
  public static class CodonWrite extends CodonType {
    public CodonWrite() {
  ...
  public static class CodonGoto extends CodonType {
    boolean direction;
  ...
  public static class CodonMemorizeTo extends CodonType {
  ...
  public static class CodonCondGoto extends CodonGoto {
  ...
  public static class CodonCompare extends CodonType {
    public CodonCompare() {
  ...
  public static class CodonFindMarker extends CodonType {
  ...
  public static class CodonCondMark extends CodonType {
  ...
  public static class CodonExists extends CodonType {
    public CodonExists() {
  ...
  public static class CodonReturnTo extends CodonGoto {
    public CodonReturnTo() {
      super(14, "return to", false);
    }
  }

  public static class CodonMoveHandBack extends CodonMoveHand {
    public CodonMoveHandBack() {
      super(15, "move hand back", false);
    }
  }

  public static class CodonRange extends CodonType {
    public CodonRange() {
  ...
  public static class CodonAddTo extends CodonType {
    public CodonAddTo() {
